...
// import { Avatar } from "@rneui/themed"; // Replaced with custom div
import { connect } from "react-redux";
import {
    setPropertyType, setPropertyDetails, setCustomerDetails,
    setStartNavigationPoint, setCommercialCustomerList
} from "./../../../../reducers/Action";
// import ModalActivityIndicator from 'react-native-modal-activityindicator'; // Replaced with simple loading text
    ...
    return customerFinalDetails ? (
        <div style={{ flex: 1, backgroundColor: "#ffffff", overflowY: 'auto', height: '100vh' }}>
            ...
            <div style={styles.detailsContainer}>
                <div style={{ ...styles.details, paddingLeft: 20, paddingRight: 20 }}>
