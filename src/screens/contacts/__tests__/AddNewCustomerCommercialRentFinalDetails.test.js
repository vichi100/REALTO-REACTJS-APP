...
import AddNewCustomerCommercialRentFinalDetails from '../commercial/rent/AddNewCustomerCommercialRentFinalDetails';
...
describe('AddNewCustomerCommercialRentFinalDetails', () => {
    let store;
