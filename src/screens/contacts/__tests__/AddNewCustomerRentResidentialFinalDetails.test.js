...
import AddNewCustomerRentResidentialFinalDetails from '../residential/rent/AddNewCustomerRentResidentialFinalDetails';
...
describe('AddNewCustomerRentResidentialFinalDetails', () => {
    let store;
