...
const ContactResidentialSellCard = props => {
    ...
    // Calculate transform for sliding drawer
    // In RN: inputRange: [0, 1], outputRange: [slidingDrawerWidth - 33, -15]
    // 0 means closed (toggle=true), 1 means open (toggle=false)
                        ...
                        >
                            ...
                            {displayChat ? (
                                <button
                                    ...
                                    style={{ paddingTop: 15, border: 'none', background: 'transparent' }}
                                >
                                    <div
                                        style={{
                                            display: 'flex',
