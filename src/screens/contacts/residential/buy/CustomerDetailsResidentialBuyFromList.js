    ...
    return (
        <div style={styles.container}>
            ...
            >
                ...
                {displayMatchCount === true && <div
                    onClick={() => getMatched(item)}
                    style={{ flexDirection: 'row', marginTop: 0, position: 'relative', width: 60, height: 60, cursor: 'pointer' }}
                >
                    <div style={{
            ...
            <div style={{ ...styles.detailsContainer, backgroundColor: "#ffffff" }}>
                <div style={styles.details}>
                    <div style={styles.subDetails}>
                        <span style={{ ...styles.subDetailsValue, marginTop: 7, display: 'block' }}>
                    ...
                    <div style={styles.subDetails}>
                        ...
                        <span style={{ ...styles.subDetailsTitle, display: 'block' }}>Buy</span>
                    </div>
                    <div style={styles.verticalLine}></div>
                    <div style={styles.subDetails}>
                        <span style={{ ...styles.subDetailsValue, display: 'block' }}>
                ...
                <div style={styles.overviewColumnWrapper}>
                    ...
                    <div style={styles.overviewRightColumn}>
                        ...
                        <div style={styles.subDetails}>
                            ...
                            <span style={{ ...styles.subDetailsTitle, display: 'block' }}>Negotiable</span>
                        </div>
                    </div>
                </div>
            </div>
...
const styles = {
    ...
    subTitle: {
        fontSize: 14,
        fontWeight: "400",
        color: "rgba(0,0,0, 0.87)" // Changed from white to black for better visibility on white bg, or check original bg
    },
    detailsContainer: {
        height: 60,
        borderBottomWidth: 1,
