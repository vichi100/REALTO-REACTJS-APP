            ...
            <div className="border-t border-gray-300 bg-gray-100 p-4 h-16">
                <div className="flex justify-between items-center h-full">
                    ...
                    <div className="pb-5">
                        ...
                        <span className="text-xs font-normal block text-black">Price</span>
                    </div>
                    <div className="h-3/4 w-px bg-gray-400"></div>
                    <div className="pb-5">
                        <span className="text-sm font-semibold block text-black">
                    ...
                    <div className="flex justify-between p-2">
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="pb-5">
                                ...
                                <span className="text-xs font-normal block text-black">Maintenance charge</span>
                            </div>
                            <div className="pb-5">
                                <span className="text-sm font-semibold block text-black">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="pb-5">
                                ...
                                <span className="text-xs font-normal block text-black">Negotiable</span>
                            </div>
                            <div className="pb-5">
                                <span className="text-sm font-semibold block text-black">
