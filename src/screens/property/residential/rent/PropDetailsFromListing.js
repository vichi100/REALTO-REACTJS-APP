            ...
            <div className="border-t border-neutral-700 bg-neutral-800/50 p-4 h-16">
                <div className="flex justify-between items-center h-full">
                    ...
                    <div className="pb-5">
                        ...
                        <span className="text-xs font-normal block text-white">Rent</span>
                    </div>
                    <div className="h-3/4 w-px bg-neutral-700"></div>
                    <div className="pb-5">
                        <span className="text-sm font-semibold block text-white">
                        ...
                        <span className="text-xs font-normal block text-white">Deposit</span>
                    </div>
                    <div className="h-3/4 w-px bg-neutral-700"></div>
                    <div className="pb-5">
                        <span className="text-sm font-semibold block text-white">
                    ...
                    <div className="flex justify-between p-2">
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="pb-5">
                                ...
                                <span className="text-xs font-normal block text-white">Preferred Tenant</span>
                            </div>
                            <div className="pb-5">
                                <span className="text-sm font-semibold block text-white">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="pb-5">
                                ...
                                <span className="text-xs font-normal block text-white">NonVeg</span>
                            </div>
                            <div className="pb-5">
                                <span className="text-sm font-semibold block text-white">
