...
const ListingResidential = props => {
    ...
    return (
        <div className="flex flex-col h-full bg-neutral-900 relative">
            <div className="flex flex-row items-center p-4 border-b border-neutral-700">
                ...
                <div className="fixed inset-0 flex justify-center items-end z-50 backdrop-blur-md" style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }} onClick={toggleBottomNavigationView}>
                    <div className="bg-neutral-900 w-full p-6 pb-20 rounded-t-[2rem] max-h-[60vh] overflow-y-auto shadow-2xl transition-all duration-300 transform translate-y-0" onClick={e => e.stopPropagation()}>
                        ...
                        {purpose === "" ? null : purpose === "Rent" ? (
                            ...
                            <div className="mb-4">
                                <h4 className="font-semibold mb-2 text-white">Sell Price Range</h4>
                                <SliderCr
                                    min={1000000}
                                    max={100000000}
                        ...
                        <div className="mb-4">
                            <h4 className="font-semibold mb-2 text-white">Furnishing</h4>
                            <CustomButtonGroup
            ...
            {visibleSorting && (
                <div className="fixed inset-0 flex justify-center items-end z-50 backdrop-blur-md" style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }} onClick={toggleSortingBottomNavigationView}>
                    <div className="bg-neutral-900 w-full p-6 pb-20 rounded-t-[2rem] max-h-[60vh] overflow-y-auto shadow-2xl" onClick={e => e.stopPropagation()}>
                        <div className="w-12 h-1.5 bg-neutral-700 rounded-full mx-auto mb-6" />
                        <div className="flex justify-between items-center mb-8 border-b border-neutral-800 pb-4">
                            <div className="w-8" />
                        ...
                        <div className="mb-4">
                            <h4 className="font-semibold mb-2 text-white">Rent</h4>
                            <CustomButtonGroup
                        ...
                        <div className="mb-4">
                            <h4 className="font-semibold mb-2 text-white">Posted date</h4>
                            <CustomButtonGroup
