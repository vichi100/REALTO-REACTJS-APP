        ...
        <div className="flex flex-col h-full">
            <div className="flex bg-white border-b border-gray-200">
                <Link
                    ...
                    className={`flex-1 py-3 text-center font-medium text-xs md:text-sm flex items-center justify-center gap-2 ${currentPath === 'reminders' || currentPath === 'NotificationTopTab' || currentPath === '' ? 'text-black border-b-2 border-green-600' : 'text-gray-500'
                        }`}
                >
                    Reminders
                </Link>
